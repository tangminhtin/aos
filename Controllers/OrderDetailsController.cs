    ...
    public class OrderDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Wishlist()
        {
            ...
            if (user != null)
            {
                ...
                checkOrderID1 = dataFashionContext1.Where(s => s.UserId.Equals(Int32.Parse(user)) && s.Status.Equals(1)).FirstOrDefault()?.Id;
                if (checkOrderID1 == 0)
                {
                    ViewData["orderdeatail"] = null;
                ...
                {
                    ViewData["orderdeatail"] = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product).Where(s => s.OrderId == checkOrderID1); ;
                }
                if (checkOrderID == 0)
                {
                    var dataFashionContext2 = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
