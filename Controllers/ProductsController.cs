...
namespace Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Details(int? id)
        {
            ...
            product.ProductTypeNavigation = _context.Types.FirstOrDefault(t => t.Id == product.ProductType);
            product.ProductColorNavigation = _context.Colors.FirstOrDefault(t => t.Id == product.ProductColor);
            product.ProductSizeNavigation = _context.Sizes.FirstOrDefault(t => t.Id == product.ProductSize);
            product.ProductBrandNavigation = _context.Brands.FirstOrDefault(t => t.Id == product.ProductBrand);
