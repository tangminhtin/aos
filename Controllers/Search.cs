...
namespace Shop.Controllers
{
    public class SearchController : Controller
    {
        ...
        public async Task<IActionResult> SearchByName(string? id, string? sort)
        {
        ...
        public IActionResult Sort(string? id, string sort)
        {
            if (id != null)
            {
                return RedirectToAction("SearchByName", new { id = id, sort = sort });
            }
            else
            {
                return RedirectToAction("SearchByName", new { sort = sort });
            }
        }
    }
}
